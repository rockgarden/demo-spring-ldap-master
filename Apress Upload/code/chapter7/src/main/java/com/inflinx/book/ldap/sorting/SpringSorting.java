...
public class SpringSorting {
	...
	public void sortByLocation() {
		...
		SortMultipleControlDirContextProcessor smcdcp = new SortMultipleControlDirContextProcessor(
				locationAttributes);
		...
		List<String> results = ldapTemplate.search("", equalsFilter.encode(), searchControls, locationMapper,
				smcdcp);
	...
	public List<String> sortByLastName() {
		...
		List<String> lastNames = ldapTemplate.search("", equalsFilter.encode(), searchControls, lastNameMapper,
				scdcp);
